	...
	<nav class="navbar navbar-inverse navbar-static-top">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://localhost:8080/">AHP (Analitycal Hierarchy Process)</a>
			</div>

			<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="http://localhost/login.php">Alfina Febrianti</a></li>
				</ul>
			</div><!-- /.navbar-collapse -->
		</div><!-- /.container-fluid -->
	</nav>
			...
			<div style="margin-top: 100px;" class="panel panel-default">
				<div class="panel-body">
					<div class="text-center">
						<marquee>BPRS AL-SALAAM AMAL SALMAN
						</marquee>
					</div>
					<form method="post">
